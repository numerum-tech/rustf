...
//! projects in sync with the canonical doc at `docs/RUSTF_SKILL.md`.
//!
...
fn main() {
    ...
    let canonical = manifest_dir.join("../docs/RUSTF_SKILL.md");
    ...
    if !canonical.exists() {
        ...
        println!(
            "cargo:warning=docs/RUSTF_SKILL.md not found at {} — \
