...
use rustf_schema::{
    AutoGenerate, BelongsTo, Field, FieldConstraints, FieldType, Relations, Schema, SchemaError,
    SchemaValidator, Table,
};
...
fn test_circular_dependency_detection() {
    ...
    table_a.fields.insert(
        "table_b_id".to_string(),
        Field {
    ...
    table_b.fields.insert(
        "table_a_id".to_string(),
        Field {
...
fn test_validate_complete_schema() {
    ...
    schema
        .tables
        .insert("User".to_string(), create_basic_table("User", "users"));
