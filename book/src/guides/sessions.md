...
> **New in 2025**: Custom session storage can now be implemented via the [Definitions System](schemas.md), providing a simpler, convention-based approach. See [Custom Session Storage via Definitions](#custom-session-storage-via-definitions-system-recommended) for details.
...
For more details on the Definitions System, see [Schemas & Definitions](schemas.md).
