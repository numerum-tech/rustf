...
- Cost, as of 2026-07-26: the repository is deep-cloned **twice** per render
  (`Context::view` materialising a `Value::Object`, then the engine building
  its render context) and the model **once**. This is an implementation
  detail being fixed — do NOT reshape a page around it. Put data where it
  belongs.
