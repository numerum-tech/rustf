...
impl TaskLists {
    ...
    // ----------------------------------------
    // let new_record = TaskLists::builder()
    ...
    // Find by ID:
    // -----------
    // let record = TaskLists::get_by_id(id).await?;
    // 
    // Query with filters:
    // -------------------
    // let results = TaskLists::query()?
    ...
    // Count records:
    // --------------
    // let total = TaskLists::count().await?;
    // let active_count = TaskLists::query()?
    ...
    // -------------------------------------
    // let mut record = TaskLists::get_by_id(id).await?.unwrap();
