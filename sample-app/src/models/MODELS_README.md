...
### 🔄 Recommended pattern:
```rust
// ✅ Correct: Business logic in the wrapper
impl User {
    pub fn validate_email(&self) -> bool {
        // Business logic here
    }
    
    pub async fn find_active(pool: &Pool<MySql>) -> Result<Vec<Self>> {
        // Uses self.base for DB operations
    }
}

// ❌ Incorrect: Never edit base models
impl UserBase {
...
## 🤖 Type Constants Pattern for AI Agents
...
### 📖 Type Constants Usage Pattern

**Instead of hardcoding types:**
```rust
// ❌ AVOID: Hardcoded types (breaks on schema changes)
...
### 🔍 AI Agent Type Discovery Pattern
