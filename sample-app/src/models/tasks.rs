...
impl Tasks {
    ...
    // Find by ID:
    // -----------
    // let record = Tasks::get_by_id(id).await?;
    // 
    // Query with filters:
    // -------------------
    // let results = Tasks::query()?
    ...
    // -------------------------------------
    // let mut record = Tasks::get_by_id(id).await?.unwrap();
