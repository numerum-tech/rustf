...
window.App = {
    ...
    init: function() {
        console.log('🚀 Sample App Smoke Application Starting...');
...
```javascript
const CACHE_NAME = 'sample_app_smoke-v1';
const urlsToCache = [
    '/static/css/main.css',
    '/static/js/main.js',
